 ...
 *  Props to author of this: https://tips4java.wordpress.com/2008/11/08/message-console/
 */
public class MessageConsole {
    ...
    public void redirectOut(Color textColor, PrintStream printStream) {
        ...
        try {
            System.setOut(new PrintStream(cos, true, "UTF-8"));
    ...
    public void redirectErr(Color textColor, PrintStream printStream) {
        ...
        try {
            System.setErr(new PrintStream(cos, true, "UTF-8"));
        } catch (UnsupportedEncodingException ex) {
            Logger.getLogger(MessageConsole.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
