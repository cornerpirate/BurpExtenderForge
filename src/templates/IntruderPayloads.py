...
# Originally from:
# https://raw.githubusercontent.com/PortSwigger/example-intruder-payloads/master/python/IntruderPayloads.py
# Then adapted to suit
...
class BurpExtender(IBurpExtender, IIntruderPayloadGeneratorFactory, IIntruderPayloadProcessor):
    ...
    extendername = "New Intruder Payload Generator" # Alter this as it becomes the name of your extension
